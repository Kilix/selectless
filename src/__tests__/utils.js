...
it('should return the closest + 1', () => expect(closestAvailable(2, 5, p => p + 1)).toBe(3))
it('should return the closest - 2', () => expect(closestAvailable(2, 5, p => p - 2)).toBe(0))
it('should return the 4', () => expect(closestAvailable(0, 5, p => p - 1)).toBe(4))
it('should return the 0', () => expect(closestAvailable(4, 5, p => p + 1)).toBe(0))
